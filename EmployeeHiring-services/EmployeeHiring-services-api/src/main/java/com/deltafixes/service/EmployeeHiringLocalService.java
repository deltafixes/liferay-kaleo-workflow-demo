...
/**
 * Provides the local service interface for EmployeeHiring. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeHiringLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeeHiringLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.deltafixes.service.impl.EmployeeHiringLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee hiring local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeHiringLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmployeeHiring addEmployeeHiring(
		String title, String summary, String name, String technology,
		String experience, ServiceContext serviceContext);
	...
	public EmployeeHiring updateStatus(
