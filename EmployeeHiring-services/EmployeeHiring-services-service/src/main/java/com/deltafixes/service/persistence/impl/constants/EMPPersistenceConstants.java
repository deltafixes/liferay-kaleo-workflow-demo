...
package com.deltafixes.service.persistence.impl.constants;
...
public class EMPPersistenceConstants {
	...
	public static final String BUNDLE_SYMBOLIC_NAME = "com.deltafixes.service";
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(EMPPersistenceConstants.class);
